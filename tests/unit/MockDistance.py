...
def mock_getDistanceBetween(city_1, city_2):
    allCosts = {
                ...
                'lon': {
                    'ams': [   587_188,     16_800],
                    'bra': [ 1_775_382,     66_899],
                    'bru': [   376_976,      7_500],
                    'bud': [ 1_956_863,     71_280],
                    'lju': [ 1_642_920,     75_660],
                    'mun': [ 1_239_780,     41_940],
                    'pra': [ 1_267_330,     62_580],
                    'vie': [ 1_541_718,     66_120],
                },
                'lju': {
